...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.email || !form.password) {
      return Swal.fire("Validation ❌", "Email and Password required", "warning");
    }
    ...
    <div className="auth-container">
      <div className="auth-card p-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input className="form-control mb-3" name="mobileNumber" placeholder="Mobile Number" onChange={handleChange} />
